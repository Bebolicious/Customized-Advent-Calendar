<template>
    <div class="frame">
        <v-card :class="active ? 'door doorOpen' : 'door'" :style="styles" @click="clickHandler(row * 6 + col)">
            <v-card-text class="headline font-weight-black text-xs-right">{{ number }}</v-card-text>
        </v-card>
